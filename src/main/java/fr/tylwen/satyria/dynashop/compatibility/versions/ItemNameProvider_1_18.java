...
public class ItemNameProvider_1_18 implements ItemNameProvider {
    
    private static final String[] POSSIBLE_VERSIONS = {"v1_18_R1", "v1_18_R2"};
    ...
    public ItemNameProvider_1_18() {
        ...
        if (detectedVersion != null) {
            try {
                ...
                Bukkit.getLogger().info("[DynaShopGUI+] Version 1.18 détectée: " + detectedVersion);
            } catch (Exception e) {
                Bukkit.getLogger().warning("[DynaShopGUI+] Échec du chargement du fournisseur 1.18: " + e.getMessage());
            }
        }
    }
