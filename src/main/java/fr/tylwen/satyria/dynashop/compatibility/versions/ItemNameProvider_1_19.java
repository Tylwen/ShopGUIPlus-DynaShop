...
public class ItemNameProvider_1_19 implements ItemNameProvider {
    
    private static final String[] POSSIBLE_VERSIONS = {"v1_19_R1", "v1_19_R2", "v1_19_R3"};
    ...
    public ItemNameProvider_1_19() {
        ...
        if (detectedVersion != null) {
            try {
                ...
                Bukkit.getLogger().info("[DynaShopGUI+] Version 1.19 détectée: " + detectedVersion);
            } catch (Exception e) {
